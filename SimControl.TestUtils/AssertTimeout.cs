...
namespace SimControl.TestUtils
{
    ...
    public static class AssertTimeout
    {
        ...
        /// <summary>Take an item from the blockingCollection until either func becomes true or the timeout expires.</summary>
        /// <typeparam name="T">Generic type parameter.</typeparam>
        /// <param name="blockingCollection">The blockingCollection to act on.</param>
        /// <param name="func">The function.</param>
        /// <returns>An enumerator that allows foreach to be used to process take until assert timeout in this collection.</returns>
