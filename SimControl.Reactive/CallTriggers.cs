...
namespace SimControl.Reactive
{
    ...
    public sealed class CallTrigger: CallTriggerBase
    {
        ...
        public CallTrigger(Effect method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    public sealed class CallTrigger<T1>: CallTriggerBase, IGenericTrigger<T1>
    {
        ...
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1> method): base(method)
        {
            Contract.Requires(method != null);
        }

        /// <summary>Initializes a new instance of the <see cref="CallTrigger&lt;T1&gt;"/> class for specifying proprty setters.</summary>
    ...
    public sealed class CallTrigger<T1, T2>: CallTriggerBase
    {
        ...
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    public sealed class CallTrigger<T1, T2, T3>: CallTriggerBase
    {
        ...
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2, T3> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    public sealed class CallTrigger<T1, T2, T3, T4>: CallTriggerBase
    {
        ...
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2, T3, T4> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    public sealed class CallTrigger<T1, T2, T3, T4, T5>: CallTriggerBase
    {
        ...
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2, T3, T4, T5> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    public sealed class CallTrigger<T1, T2, T3, T4, T5, T6>: CallTriggerBase
    {
        ...
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2, T3, T4, T5, T6> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="CallTrigger&lt;T1, T2, T3, T4, T5, T6, T7&gt;"/> class.</summary>
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2, T3, T4, T5, T6, T7> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="CallTrigger&lt;T1, T2, T3, T4, T5, T6, T7, T8&gt;"/> class.</summary>
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2, T3, T4, T5, T6, T7, T8> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="CallTrigger&lt;T1, T2, T3, T4, T5, T6, T7, T8, T9&gt;"/> class.</summary>
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2, T3, T4, T5, T6, T7, T8, T9> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="CallTrigger&lt;T1, T2, T3, T4, T5, T6, T7, T8, T9, T10&gt;"/>
        ///     class.</summary>
        /// <param name="method">The method.</param>
        public CallTrigger(Effect<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> method): base(method)
        {
            Contract.Requires(method != null);
        }
    }
